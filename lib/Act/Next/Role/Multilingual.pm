...
sub _multilingual_new {
  ...
  foreach my $param ($self->_RESOURCE_DATASTORE->attributes_multilingual) {
...
################################################################################
#
# _to_json SHOULD NOT be here XXX
#
# this is part of the REST interface, objects are not responsible of serializing
#
################################################################################
